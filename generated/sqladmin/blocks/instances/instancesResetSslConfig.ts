    ...
    default: {
      config: {
        ...
        mode: {
          name: "Mode",
          description:
            "Optional. Reset SSL mode to use. Valid values: RESET_SSL_MODE_UNSPECIFIED, ALL, SYNC_FROM_PRIMARY",
          type: "string",
          required: false,
        },
      },
      onEvent: async (input) => {
        ...
        const path = `v1/projects/{project}/instances/{instance}/resetSslConfig`;

...
const locationsExportImageMetadata: AppBlock = {
  name: "Locations - Export Image Metadata",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const path = `v2/{+name}:exportImageMetadata`;
...
export default locationsExportImageMetadata;

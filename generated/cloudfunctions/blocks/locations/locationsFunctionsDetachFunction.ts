...
const locationsFunctionsDetachFunction: AppBlock = {
  name: "Locations - Detach Function",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const path = `v2/{+name}:detachFunction`;
...
export default locationsFunctionsDetachFunction;

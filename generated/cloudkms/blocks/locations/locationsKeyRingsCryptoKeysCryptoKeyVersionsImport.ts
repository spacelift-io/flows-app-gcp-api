...
const locationsKeyRingsCryptoKeysCryptoKeyVersionsImport: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const path = `v1/{+parent}/cryptoKeyVersions:import`;
...
export default locationsKeyRingsCryptoKeysCryptoKeyVersionsImport;

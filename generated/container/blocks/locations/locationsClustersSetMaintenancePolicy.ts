...
const locationsClustersSetMaintenancePolicy: AppBlock = {
  name: "Locations - Set Maintenance Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const path = `v1/{+name}:setMaintenancePolicy`;
...
export default locationsClustersSetMaintenancePolicy;

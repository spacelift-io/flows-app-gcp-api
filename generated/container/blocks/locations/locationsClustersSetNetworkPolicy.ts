...
const locationsClustersSetNetworkPolicy: AppBlock = {
  name: "Locations - Set Network Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const path = `v1/{+name}:setNetworkPolicy`;
...
export default locationsClustersSetNetworkPolicy;

...
const locationsClustersCompleteIpRotation: AppBlock = {
  name: "Locations - Complete Ip Rotation",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const path = `v1/{+name}:completeIpRotation`;
...
export default locationsClustersCompleteIpRotation;

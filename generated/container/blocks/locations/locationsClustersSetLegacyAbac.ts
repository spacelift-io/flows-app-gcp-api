...
const locationsClustersSetLegacyAbac: AppBlock = {
  name: "Locations - Set Legacy Abac",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const path = `v1/{+name}:setLegacyAbac`;
...
export default locationsClustersSetLegacyAbac;

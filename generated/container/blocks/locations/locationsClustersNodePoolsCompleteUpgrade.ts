...
const locationsClustersNodePoolsCompleteUpgrade: AppBlock = {
  name: "Locations - Complete Upgrade",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const path = `v1/{+name}:completeUpgrade`;
...
export default locationsClustersNodePoolsCompleteUpgrade;

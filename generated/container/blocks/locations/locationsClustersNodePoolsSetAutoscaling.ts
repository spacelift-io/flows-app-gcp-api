...
const locationsClustersNodePoolsSetAutoscaling: AppBlock = {
  name: "Locations - Set Autoscaling",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const path = `v1/{+name}:setAutoscaling`;
...
export default locationsClustersNodePoolsSetAutoscaling;

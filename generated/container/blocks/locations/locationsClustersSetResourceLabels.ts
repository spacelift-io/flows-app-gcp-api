...
const locationsClustersSetResourceLabels: AppBlock = {
  name: "Locations - Set Resource Labels",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const path = `v1/{+name}:setResourceLabels`;
...
export default locationsClustersSetResourceLabels;

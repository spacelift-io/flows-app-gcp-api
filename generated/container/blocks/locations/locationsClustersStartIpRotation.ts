...
const locationsClustersStartIpRotation: AppBlock = {
  name: "Locations - Start Ip Rotation",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const path = `v1/{+name}:startIpRotation`;
...
export default locationsClustersStartIpRotation;

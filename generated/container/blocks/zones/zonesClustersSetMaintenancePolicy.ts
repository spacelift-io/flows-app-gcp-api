...
const zonesClustersSetMaintenancePolicy: AppBlock = {
  name: "Zones - Set Maintenance Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const path = `v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}:setMaintenancePolicy`;
...
export default zonesClustersSetMaintenancePolicy;

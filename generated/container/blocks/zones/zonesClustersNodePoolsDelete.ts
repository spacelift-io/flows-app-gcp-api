...
const zonesClustersNodePoolsDelete: AppBlock = {
  name: "Zones - Delete",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const path = `v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/nodePools/{nodePoolId}`;
...
export default zonesClustersNodePoolsDelete;

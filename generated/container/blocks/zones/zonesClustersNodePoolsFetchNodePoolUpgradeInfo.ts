...
const zonesClustersNodePoolsFetchNodePoolUpgradeInfo: AppBlock = {
  name: "Zones - Fetch Node Pool Upgrade Info",
...
export default zonesClustersNodePoolsFetchNodePoolUpgradeInfo;
